...
const AGENCY_OPTIONS = [
  { value: "สโมสรนักศึกษา- Student Association", label: "สโมสรนักศึกษา", sublabel: "ฝ่ายภายในสโมสร" },
  { value: "ชมรม - Student Club", label: "ชมรม", sublabel: "ชื่อชมรม" },
  { value: "ภาควิชา - Department", label: "ภาควิชา", sublabel: "ชื่อภาควิชา" },
];
...
export default function SubmitPage() {
  ...
  const selectedAgency = AGENCY_OPTIONS.find((a) => a.value === agencyType);
  ...
  async function handleSubmit() {
    ...
    if (!agencyType || !agencyValue.trim()) {
      setErrorMsg("กรุณาเลือกและระบุหน่วยงานที่ยื่นเอกสาร");
      setStatus("error");
      return;
    }
    if (!acknowledged) {
    ...
    formData.append("agencyValue", agencyValue.trim());
  ...
  return (
    <main style={{ padding: 24, fontFamily: "sans-serif", maxWidth: 560, margin: "0 auto" }}>
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
        ...
        {selectedAgency && (
          <input
            placeholder={selectedAgency.sublabel + " *"}
            value={agencyValue}
